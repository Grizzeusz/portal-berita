        ...
        <div class="relative mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
            ...
            <div class="mt-5 grid gap-4 sm:mt-5 lg: lg:">
                ...
                <div class="relative lg:w-full">
                    ...
                    <div
                        class="relative flex h-full w-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">


                        <div class="container mx-auto flex flex-col text-start h-full px-10 font-semibold gap-5 py-10  ">
                            <form class= "space-y-3" action="/post" method="POST">
                                @csrf
                                <div >
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <textarea
                                             id="body" name="body"  autocomplete="current-body"
                                             required
                                            class="text-black pl-5 block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-black focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" ></textarea>
                                    </div>
                                </div>
